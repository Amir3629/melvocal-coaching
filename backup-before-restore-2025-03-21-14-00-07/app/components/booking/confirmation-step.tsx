  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        // Let the notification finish fading out
        setTimeout(() => {
          // Call onClose to close the booking form with animation
          // The parent component will handle scrolling to top after closing
          if (onClose) {
            onClose();
          }
        }, 500);
