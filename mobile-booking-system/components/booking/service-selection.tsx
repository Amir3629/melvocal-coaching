      ...
      <div className="flex flex-col space-y-3 mb-4 mx-auto">
        ...
        >
          <div className="flex items-center">
            <div className="w-12 h-12 rounded-full bg-[#1A1A1A] flex items-center justify-center mr-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-400 text-sm">{t("booking.nachVereinbarung", "Nach Vereinbarung")}</p>
            </div>
            {selectedService === "professioneller-gesang" && (
              <div className="w-7 h-7 rounded-full bg-[#C8A97E] flex items-center justify-center ml-2">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="flex-1 min-w-0">
              <h4 className="text-lg font-medium text-white truncate">{t("booking.jazzWorkshop", "Jazz Workshop")}</h4>
              <p className="text-gray-400 text-sm">{t("booking.variableDuration", "Variable Dauer")}</p>
            </div>
            {selectedService === "gesangsunterricht" && (
              <div className="w-7 h-7 rounded-full bg-[#C8A97E] flex items-center justify-center ml-2">
                <Check className="w-4 h-4 text-black" />
