    ...
    <ErrorBoundary>
      <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', padding: '20px', color: '#333' }}>
        ...
        <div style={{ marginBottom: '30px' }}>
          <p>Hallo {ensureString(formData.name)},</p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              ...
              <tr>
                ...
                <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.name)}</td>
              </tr>
              <tr>
                <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>E-Mail:</td>
                <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.email)}</td>
              </tr>
              <tr>
                <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Telefon:</td>
                <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.phone)}</td>
              </tr>
            ...
            {serviceType === 'professioneller-gesang' && (
              <>
                <tr>
                  ...
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(getEventTypeName())}</td>
                </tr>
                <tr>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Datum der Veranstaltung:</td>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formatDate(formData.eventDate))}</td>
                </tr>
                <tr>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Anzahl der Gäste:</td>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.guestCount)}</td>
                </tr>
                {formData.jazzStandards && (
                  <tr>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Jazz Standards:</td>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.jazzStandards)}</td>
                  </tr>
                )}
              </>
            )}
            ...
            {serviceType === 'vocal-coaching' && (
              <>
                <tr>
                  ...
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.sessionType)}</td>
                </tr>
                <tr>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Erfahrungslevel:</td>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.skillLevel)}</td>
                </tr>
                {formData.preferredDate && (
                  <tr>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Bevorzugtes Datum:</td>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formatDate(formData.preferredDate))}</td>
                  </tr>
                )}
                {formData.preferredTime && (
                  <tr>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Bevorzugte Uhrzeit:</td>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.preferredTime)}</td>
                  </tr>
                )}
              </>
            )}
            ...
            {serviceType === 'gesangsunterricht' && (
              <>
                <tr>
                  ...
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.workshopTheme)}</td>
                </tr>
                <tr>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Gruppengröße:</td>
                  <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.groupSize)}</td>
                </tr>
                {formData.workshopDuration && (
                  <tr>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', fontWeight: 'bold' }}>Workshop-Dauer:</td>
                    <td style={{ padding: '8px 0', borderBottom: '1px solid #eee' }}>{ensureString(formData.workshopDuration)}</td>
                  </tr>
                )}
              </>
            )}
            ...
            {formData.message && (
              <tr>
                ...
                <td style={{ padding: '8px 0', borderBottom: '1px solid #eee', whiteSpace: 'pre-line' }}>{ensureString(formData.message)}</td>
              </tr>
            )}
            </tbody>
          </table>
